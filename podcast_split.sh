...
echo "Durationb (sec): $duration_sec"

# 100 min
if [[ $duration_sec -le 6000 ]]; then
 echo "Splitting into 2 pieces..."
 ffmpeg -i "$file" -ss 00:00:00.000 -t 00:50:00.0 -acodec copy "${filename}_1.${extension}" -loglevel fatal
 ffmpeg -i "$file" -ss 00:50:00.000 -t 00:50:00.0 -acodec copy "${filename}_2.${extension}" -loglevel fatal
 echo "Done!"
# 150 min
 ...
 ffmpeg -i "$file" -ss 00:00:00.000 -t 00:50:00.0 -acodec copy "${filename}_1.${extension}" -loglevel fatal
 ffmpeg -i "$file" -ss 00:50:00.000 -t 00:50:00.0 -acodec copy "${filename}_2.${extension}" -loglevel fatal
 ffmpeg -i "$file" -ss 01:40:00.000 -t 00:50:00.0 -acodec copy "${filename}_3.${extension}" -loglevel fatal
 echo "Done!"
# 200 min
 ...
 ffmpeg -i "$file" -ss 00:50:00.000 -t 00:50:00.0 -acodec copy "${filename}_2.${extension}" -loglevel fatal
 ffmpeg -i "$file" -ss 01:40:00.000 -t 00:50:00.0 -acodec copy "${filename}_3.${extension}" -loglevel fatal
 ffmpeg -i "$file" -ss 02:30:00.000 -t 00:50:00.0 -acodec copy "${filename}_4.${extension}" -loglevel fatal
 echo "Done!"
fi
