...
https_prgs="/usr/bin/luakit:XW  /usr/bin/w3m:XT"
http_prgs="/usr/bin/luakit:XW  /usr/bin/w3m:XT"
mailto_prgs="/usr/bin/mutt:VT"
gopher_prgs="/usr/bin/w3m:XT /usr/bin/gopher:XT"
ftp_prgs="/usr/bin/w3m:XT /usr/bin/ncftp:XT"
